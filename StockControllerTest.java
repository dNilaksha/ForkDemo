...
public class StockControllerTest {
	...
	public void testStockControllerIsOk() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/stock/openstock/draft").
	  ...
	  public void testStockControllerIsNotFound() throws Exception {
		  ...
		  mockMvc.perform(MockMvcRequestBuilders.get("/stock/openstock/drafts").
	  contentType(MediaType.APPLICATION_JSON))
	...
	List<StockDetails> stockDetails = new ArrayList<StockDetails>();
	  ...
	  ObjectMapper mapper = new ObjectMapper(); String s =
	  mapper.writeValueAsString(stockobj);
	  
	  mockMvc.perform(
	  MockMvcRequestBuilders.post("/stock/openstock/draft").contentType(MediaType.
	  APPLICATION_JSON).content(s))
	  .andExpect(MockMvcResultMatchers.status().isOk());
	  ...
	  mockMvc.perform(MockMvcRequestBuilders.post("/stock/openstock/draft").
